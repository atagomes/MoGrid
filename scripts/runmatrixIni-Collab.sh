...
echo
echo "STARTing RunMatrix Initiator-Collaborator Application"
echo
...
$JAVA_EXE -Dlog4j.configuration=$MOGRID_CONF/MoGridLog4j.xml -Dmogrid.home=$MOGRID_HOME -classpath $MOGRID_BIN/mogrid.jar\:$MOGRID_LIB/log4j.jar\:$MOGRID_CONF\:$MOGRID_CONF/DiscoveryProtocol.properties martin.app.bagoftask.matrix.RunMatrixInitiator 8 60000 $JAVA_HOME/bin/
