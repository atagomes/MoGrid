 ...
 * 
 * Source: http://dev.w3.org/cvsweb/~checkout~/java/classes/org/w3c/tools/crypt/Md5.java?rev=1.5
 */
...
public class MD5 implements Payload {
   
   /** Comment for <code>serialVersionUID</code> */
   private static final long serialVersionUID = 5107523649974687913L;
   ...
   private static byte padding[] = { 
         (byte) 0x80, (byte) 0, (byte) 0, (byte) 0,
   ...
   /**
    * Get the digest, for this string digestifier. This method doesn't throw any
    * IOException, since it knows that the underlying stream ws built from a
    * String.
    */
